...
def population(n_de_individuos, n_de_itens):
    ...
    #Verifica os itens dentro da mochila e valida cada item multiplicando
    #Se o valor ultrapassar o peso maximo desfraxifica
...
def fitness(individuo, peso_maximo, pesos_e_valores):
    ...
    #Com os individos aptos ele calcula a media da populacao desclasificando os igual a 0
...
def media_fitness(populacao, peso_maximo, pesos_e_valores): #só leva em consideracao os elementos que respeitem o peso maximo da mochila
    ...
    #Roleta sem duplicatas e repeticoes de sorteio os individos para ser um Pai e uma Mae
...
def selecao_roleta(pais):
    ...
    #Sorteia um pai e uma mae para fazer a reproducao cortando ao meio o pai e a mae, podendo fazer uma mutacao
...
def evolve(populacao, peso_maximo, pesos_e_valores, n_de_cromossomos, mutate=0.05): 
    ...
    # REPRODUCAO  [0, 0, 1, 1, 1, 0, 1, 1, 1, 1]
    filhos = []
